(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('showCasesApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-showCasesApp-error');
                var entityKey = httpResponse.headers('X-showCasesApp-params');
                if (errorHeader) {
